...
public final class ListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView listCalories;
  ...
  private ListItemBinding(@NonNull CardView rootView, @NonNull TextView listCalories,
      @NonNull ShapeableImageView listImage, @NonNull TextView listName) {
    this.rootView = rootView;
    this.listCalories = listCalories;
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.listCalories;
      TextView listCalories = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ListItemBinding((CardView) rootView, listCalories, listImage, listName);
    }
